...
#2. 모델구성
model = Sequential()
model.add(Conv2D(30, (2,2), input_shape= (5,2,1), padding= 'same'))
...
hist = model.fit(x_train, y_train, callbacks=[mcp, es], epochs= 10000, batch_size = 5, validation_split= 0.3)
end_time = time.time()
...
# #cnn
# R2 스코어 : 0.5774956965694489
#로스 : [2588.49658203125, 0.0]
# 걸린 시간 : 10.6 초
