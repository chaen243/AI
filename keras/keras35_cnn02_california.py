...
x = x.reshape(20640,2,4,1)
x_train = x_train.reshape(17544,2,4,1)
x_test = x_test.reshape(3096,2,4,1)
...
model= Sequential()
model.add(Conv2D(50, (2,2), input_shape= (2, 4, 1), padding='same'))
...
hist = model.fit(x_train, y_train, callbacks=[mcp, es], epochs= 10000, batch_size = 200, validation_split= 0.27)
end_time = time.time()
...
# #cnn
# 로스 : 1.2808582782745361
# R2 스코어 : 0.0308769731543046
# 걸린 시간 : 11.84 초
