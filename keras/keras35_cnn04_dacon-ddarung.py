...
# x_train = x_train.values.reshape(929,3,3,1)
# x_test = x_test.values.reshape(399,3,3,1)
...
model = Sequential()
model.add(Conv2D(50, (2,2), input_shape= (3,3,1), padding='same'))
...
hist = model.fit(x_train, y_train, callbacks=[mcp, es], epochs=10000, batch_size = 25, validation_split= 0.36)
end_time = time.time()
...
#cnn
# 로스 : [2299.491455078125, 0.0]
# R2 스코어 : 0.6486882498964872
# 걸린 시간 : 454.14 초