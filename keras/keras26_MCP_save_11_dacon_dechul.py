...
filepath = "".join([path, 'k26_11', date, "_", filename]) #""공간에 ([])를 합쳐라.
...
hist = model.fit(x_train, y_train, callbacks=[es,mcp], epochs= 15000, batch_size = 250, validation_split= 0.2, verbose=2)
