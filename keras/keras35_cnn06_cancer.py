...
model = Sequential()
model.add(Conv2D(50, (2,2), input_shape=(3,10,1)))
model.add(Conv2D(20, (1,2)))
model.add(Flatten())
...
hist = model.fit(x_train, y_train, callbacks=[mcp,es], epochs= 10000, batch_size = 8, validation_split= 0.25)
end_time= time.time()
