...
# model = LinearSVC() acc : 0.8888888888888888
# model = Perceptron() acc : 0.6944444444444444
# model = LogisticRegression() acc : 0.9722222222222222
# model = KNeighborsClassifier() acc : 0.7777777777777778
# model = DecisionTreeClassifier() acc : 0.8888888888888888
# model = RandomForestClassifier() acc : 0.9722222222222222
