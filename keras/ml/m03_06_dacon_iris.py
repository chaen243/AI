...
model = LinearSVC() #acc : 0.9722222222222222
model = Perceptron() #acc : 0.6388888888888888
model = LogisticRegression() #acc : 0.9444444444444444
model = KNeighborsClassifier() #acc : 0.9722222222222222
model = DecisionTreeClassifier() #acc : 0.9444444444444444
# model = RandomForestClassifier() acc : 0.9444444444444444
