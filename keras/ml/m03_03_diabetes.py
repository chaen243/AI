...
#2. 모델구성
# model = LinearSVC() model.score: 0.6326530612244898
# model = Perceptron() model.score: 0.45918367346938777
# model = LogisticRegression() model.score: 0.673469387755102
# model = KNeighborsClassifier() model.score: 0.5816326530612245
# model = DecisionTreeClassifier() model.scre:  0.6530612244897959
# model = RandomForestClassifier() model.score: 0.6632653061224489
