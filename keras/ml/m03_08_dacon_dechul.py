...
# model = LinearSVC() F1:  0.20561926550285511
# model = Perceptron() F1:  0.26319726817704053
# model = LogisticRegression()  F1:  0.24432818549315868
# model = KNeighborsClassifier() F1:  0.26319726817704053
# model = DecisionTreeClassifier() F1:  0.7553518226901671
# model = RandomForestClassifier() F1:  0.6882609865906276 
