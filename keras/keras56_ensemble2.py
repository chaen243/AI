...
print(x1_datasets.shape, x2_datasets.shape, x3_datasets) #(100, 2) (100, 3)
...
model.fit([x1_train,x2_train, x3_train], y_train, epochs=123, batch_size=20)
