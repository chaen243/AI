...
x_train = x_train.values.reshape(8382,2,2,2)
x_test = x_test.values.reshape(2504,2,2,2)
...
#2. 모델구성
model = Sequential()
model.add(Conv2D(50, (2,2), input_shape= (2,2,2), padding= 'same'))
model.add(Conv2D(20, (2,2), input_shape= (2,2,2), padding= 'same'))
model.add(Flatten())
...
#cnn
# RMSE :  210.34041253787055
# 로스 : [44243.09375, 44243.09375]
# RMSLE : 1.2457570126558588
