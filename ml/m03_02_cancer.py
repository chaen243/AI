...
#2. 모델구성
# model= LinearSVC() acc : 0.9726775956284153
# model = LogisticRegression() acc : 0.9836065573770492
#model = KNeighborsClassifier() acc : 0.9781420765027322
#model = DecisionTreeClassifier() acc : 0.8633879781420765
#model = RandomForestClassifier() acc : 0.9672131147540983
