...
# model = LinearSVC() acc : 0.3667041490728842
# model = Perceptron() acc : 0.5980011933174224 
# model = LogisticRegression() acc : 0.5980011933174224
# model = KNeighborsClassifier() model.score : 0.9651815219386819
# model = DecisionTreeClassifier() acc : 0.9343675417661098
# model = RandomForestClassifier() acc : 0.9525369469432715
