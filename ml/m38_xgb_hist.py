...
model.set_params(early_stopping_rounds= 50, #반환 디폴트 트루!
    **parameters)
...
test_metric = hist['validation_1']['mae']

plt.plot(train_metric, label='Training MAE')
plt.plot(test_metric, label='Validation MAE')
plt.xlabel('Epochs')
plt.ylabel('MAE')
plt.title('hist')
plt.legend()
