...
train_path = pathlib.Path("C:\classified_video_320\\train")
test_path = pathlib.Path("C:\classified_video_320\\test")
val_ds = pathlib.Path("C:\classified_video_320\\val")
...
for frames, labels in test_ds.take(10):
  print("labels : ",labels)
import os  
train_CLASSES = sorted(os.listdir("C:\classified_video_320\\train"))
test_CLASSES = sorted(os.listdir("C:\classified_video_320\\test"))
...
# 모델에 가중치 로드
model.load_weights("C:\classified_video_320/movinet_gazua_w2.h5")
...
# print("가중치 저장!!!!")
# model.save_weights("C:\classified_video_320/movinet_gazua_w2.h5")
# model.save("C:\classified_video_320/movinet_gazua_m2.h5")
# print("가중치 저장!!!!")
