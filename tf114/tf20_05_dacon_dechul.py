...
w1 = tf.compat.v1.Variable(tf.random_normal([13,1024]))
b1 = tf.compat.v1.Variable(tf.zeros([1024]))
layer1 = tf.nn.relu(tf.compat.v1.matmul(x, w1) + b1 )


w2 = tf.compat.v1.Variable(tf.random_normal([1024,512]))
b2 = tf.compat.v1.Variable(tf.zeros([512]))
layer2 = tf.nn.relu(tf.compat.v1.matmul(layer1, w2) + b2)


w3 = tf.compat.v1.Variable(tf.random_normal([512,256]))
b3 = tf.compat.v1.Variable(tf.zeros([256]))
layer3 = tf.nn.relu(tf.compat.v1.matmul(layer2, w3) + b3)


w4 = tf.compat.v1.Variable(tf.random_normal([256,128]))
b4 = tf.compat.v1.Variable(tf.zeros([128]))
layer4 = tf.nn.relu(tf.compat.v1.matmul(layer3, w4) + b4)


w5 = tf.compat.v1.Variable(tf.random_normal([128,64]))
b5 = tf.compat.v1.Variable(tf.zeros([64]))
layer5 = tf.nn.relu(tf.compat.v1.matmul(layer4, w5) + b5)


w6 = tf.compat.v1.Variable(tf.random_normal([64,32]))
b6 = tf.compat.v1.Variable(tf.zeros([32]))
layer6 = tf.nn.softmax(tf.compat.v1.matmul(layer5, w6) + b6)


w7 = tf.compat.v1.Variable(tf.random_normal([32,7]))
