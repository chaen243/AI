...
with tf.compat.v1.Session() as sess:
    ...
    #######placeholder#########
    y_pred2 = x_test * w_val + b_val
    y_pred2 = y_pred2.eval(feed_dict= {x_test: x_pred_data})
    #print('[6,7,8]의 예측 : ', sess.run(y_pred2, feed_dict= {x_test: x_pred_data}))
...
sess.run(tf.compat.v1.global_variables_initializer()) #위의 변수를 초기화!
...
y_pred3 = y_pred.eval(feed_dict={x_test: x_pred_data})
    #print('[6,7,8]의 예측 : ', sess.run(y_pred2, feed_dict= {x_test: x_pred_data}))
